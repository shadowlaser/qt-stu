...
**
** Created: Sun Aug 19 09:43:18 2012
...
static const char qt_meta_stringdata_LCDRange[] = {
    "LCDRange\0\0valueChanged(int)\0value\0"
    "setValue(int)\0minVal,maxVal\0"
    "setRange(int,int)\0"
};
...
const QMetaObject LCDRange::staticMetaObject = {
    { &QVBoxLayout::staticMetaObject, qt_meta_stringdata_LCDRange,
